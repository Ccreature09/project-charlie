      ...
      <div className="flex bg-[#121212] text-white min-h-screen">
        ...
        <div className="bg-gray-800 w-1/6 p-6">
          ...
          <ul className="space-y-2">
            <li>
              <a href="#if-statement" className="text-blue-500 hover:underline">
                If Statement
              </a>
            </li>
        ...
        <div className="w-3/4 bg-[#121212] p-8">
          <h1 className="text-white font-bold text-5xl mb-6">Documentation</h1>
          ...
          <section id="if-statement" className="py-8">
            ...
            <p className="text-lg leading-7">
              The <code className="bg-gray-800 p-1 rounded">if</code> statement
              is used to make decisions in your code. It evaluates a condition
